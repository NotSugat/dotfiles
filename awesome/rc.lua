...
local tags = sharedtags({
	...
	{ name = "󰈎 ", layout = awful.layout.layouts[10] },
	{ name = "󰙯 ", layout = awful.layout.layouts[1] },
	{ name = " ", layout = awful.layout.layouts[2] },
...
awful.screen.connect_for_each_screen(function(s)
	...
	-- 	-- Create tags for the first screen
	-- 	awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
	-- else
	-- 	if s.index == 1 then
	-- 		-- Create tags for the first screen
	-- 		awful.tag({ "1", "3", "4", "5", "6", "7", "8" }, s, awful.layout.layouts[1])
	-- 	elseif s.index == 2 then
	-- 		-- Create tags for the second screen
	-- 		awful.tag({ "2", "9" }, s, awful.layout.layouts[1])
	-- 	end
	-- end
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Shift" }, "k", function() awful.client.swap.byidx(-1) end,
		{ description = "swap with preAltvious client by index", group = "client" }),
	...
	-- opens firefox
	awful.key({ modkey }, "Return", function() awful.util.spawn("firefox") end,
